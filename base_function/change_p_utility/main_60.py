...
#主函数
def main_60(model,EC_choose,group_utility,SES_x_all,SES_x_res,SES_cost,SES_price,SES_utility):
    ...
    while flag2 == 1:
        ...
        while flag == 1:
            ...
            EC_x_res = compute_x_res(model,SES_choosed,SES_x_res)
            ...
            #EC停止演化条件
            tran_flag = ( EC_transition <= 0.009 )  #值为 0 or 1
