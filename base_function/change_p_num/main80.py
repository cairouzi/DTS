...
from base_function.change_p_num.SES_iterative_ import SES_iterative_
from compute_x_res import compute_x_res


#主函数
def main80(model,EC_choose,group_utility,SES_x_all,SES_x_res,SES_cost,SES_price,SES_utility):
    ...
    while flag2 == 1:
        ...
        if flag2 == 1:
            ...
            cur_dfx,SES_price = SES_iterative_(model,EC_x_res,SES_choosed,SES_x_all,SES_x_res,SES_price,SES_cost,cur_dfx_)
            cur_dfx_ = cur_dfx
