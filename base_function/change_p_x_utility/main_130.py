...
from SES_iterative_res import SES_iterative_res

#主函数
def main_130(model,EC_choose,group_utility,SES_x_all,SES_x_res,SES_cost,SES_price,SES_utility):
    ...
    while flag2 == 1:
        ...
        while flag == 1:
            ...
            #EC停止演化条件
            tran_flag = ( EC_transition <= 0.028 )  #值为 0 or 1
