...
#主函数
def main_100(model,EC_choose,group_utility,SES_x_all,SES_x_res,SES_cost,SES_price,SES_utility):
    ...
    while flag2 == 1:
        ...
        while flag == 1:
            ...
            #EC停止演化条件 change_p_utility = 0.01
            #change_p_ = 0.004
            tran_flag = ( EC_transition <= 0.02)  #值为 0 or 1
    ...
    print("当前交易完成")
    print("\n")
    return SES_utility,SES_choosed,group_SES,EC_x_res,SES_x_res