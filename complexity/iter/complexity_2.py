...
def complexity_2():
        ...
        for i in (range(NUM_RUNS)):
                ...
                EC_choose = [[1,2,1,2,3,5,1,1,4,3,4,2,2,4,5,2,3,3,2,4,1,2,1,4,1,3,4,5,5,2,1,4,4,1,1,2,4,5,1,2,3,5,1,1,4,3,3,2,2,4,5,2,1,3,4,5,3,3,2,4,4,1,1,2,5,2,1,4,4,5],[5,5,3,5,1,1,4,3,3,1,1,3,4,5,2,3,5,1,1,4,3,3,2,2,4,5,2,3,3,2,4,4,1,1,5,2,1,4,1,3,4,5,2,1,5,5,2,2,4,5,2,3,3,2,5,2,1,4,4,4,1,1,2,4,4,5,1,3,4,5]]
